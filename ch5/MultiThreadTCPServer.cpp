...
DWORD WINAPI ProcessClient(LPVOID arg) {
    ...
    getpeername(client_sock, (SOCKADDR*)&clientaddr, &addrlen); // 소켓, 원격주소, 길이
...
// 스레드 작업에 필요한 함수 정의
// DWORD WINAPI 함수명(매개변수) ==> 매개변수의 형변환

// CreateThread(NULL, 0, 함수명, 매개변수, 실행여부(0=바로실행), NULL)
// CREATE_SUSPEND => Resum..이 될 때까지 기다린 후 실행
// getpeername(): 원격 ip/port 번호 체크하는 함수
